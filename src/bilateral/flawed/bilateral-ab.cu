#include "bilateral-ab.hpp"
#include "gpu-utils.hpp"
#include "cuda-utils.hpp"
//Artificial barrier, useless barrier
template<int R>
...
KernelStats ABBilateral::run(const BilateralData &data, const BilateralSettings &settings, BilateralData &result) const {
...
REGISTER_CLASS(IBilateral,ABBilateral);