...
KernelStats LUBilateral::run(const BilateralData &data, const BilateralSettings &settings, BilateralData &result) const {
...
REGISTER_CLASS(IBilateral,LUBilateral);